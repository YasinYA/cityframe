...
// Memoized Grid Overlay - static SVG pattern
...
// Memoized Vignette Overlay - only re-renders when vignetteSize or color changes
...
// Memoized Watermark Overlay - static for non-authenticated users
...
export default function MapViewClient() {
  ...
  return (
    ...
    >
      ...
      {showVignette && <VignetteOverlay vignetteSize={vignetteSize} vignetteColor={vignetteColor} />}

      {/* Watermark Overlay for non-authenticated users */}
      {!authenticated && <WatermarkOverlay />}
